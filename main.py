...
global footer
footer='<div id="footer-wrapper"><footer id="footer" class="container"><div class="row"><div class="col-9 col-9-medium col-12-small"><section class="widget links"><h3>Patrocinadores</h3><ul class="style2"><li><img src="../images/fs.png" style="width:150px;padding:20px"><img src="../images/zarca.jpeg" style="width:150px;padding:20px"><img src="../images/secreto.jpeg" style="width:150px;padding:20px"><img src="../images/yoki.jpeg" style="width:150px;padding:20px"><img src="../images/sofagrup.jpeg" style="width:150px;padding:20px"><img src="../images/cerro.png" style="width:150px;padding:20px"></li></ul></section></div><section class="widget contact last"><h3>Contacto</h3><ul><li><a href="https://www.instagram.com/cfviladecavalls_veteranos/?hl=es" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li></ul><p>Camp de Futbol Municipal Jaume Collado i Llorach <br />08232 Viladecavalls<br />Barcelona, España</p></section></div></div><div class="row"><div class="col-12"><div id="copyright"><ul class="menu"><li>&copy; Doki Studio 2022. All rights reserved</li><li>Design: <a href="http://dokistudio.es">Doki Studio</a></li></ul></div></div></div></footer></div></div>'
